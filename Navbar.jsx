...
function Navbar  ()  {
  ...
  <div className="">
    <a className="bg-slate-800 px-2 py-2 text-white rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={()=> document.getElementById("my_modal_3").showModal()
